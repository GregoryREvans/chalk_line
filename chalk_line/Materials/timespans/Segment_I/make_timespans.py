...
# rhythm#
########
rhythm_target_timespan = abjad.Timespan(0, 60)
...
# pitch#
#######
pitch_target_timespan = abjad.Timespan(0, 60)
...
# dynamic#
#########
dynamic_target_timespan = abjad.Timespan(0, 60)
...
# articulation#
##############
articulation_target_timespan = abjad.Timespan(0, 60)
