...
from chalk_line.Materials.rhythm.Segment_II.rhythm_handlers import *
...
# pitch#
#######
pitch_target_timespan = abjad.Timespan(0, 30)
...
# dynamic#
#########
dynamic_target_timespan = abjad.Timespan(0, 28)
...
tempo_timespan_maker = TaleaTimespanMaker(
    ...
    playing_talea=rmakers.Talea(counts=([12, 9, 11, 12, 12, 10, 11, 9, 12, 12]), denominator=8),
